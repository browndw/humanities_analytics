...
**spaCy Processing** ([Tutorial: spaCy Basics](../tutorials/spacy-basics.qmd))
...
**Vector Models (Word2Vec, Embeddings)** ([Tutorial: Vector Models](../tutorials/spacy-basics.qmd), [Contextual Embeddings](../tutorials/contextual-embeddings.qmd))
...
**ANOVA and R²** ([Tutorial: ANOVA](../tutorials/categorical-variables.qmd))
